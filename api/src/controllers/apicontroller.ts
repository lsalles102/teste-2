...
// Configuração do domínio do jogo via variável de ambiente
const GAME_DOMAIN = process.env.GAME_DOMAIN || 'm.pg-nmgaa.com'
         ...
         if (user.length === 0) {
            ...
            if (createnewuser.affectedRows >= 1) {
               ...
               res.send({
                  status: 1,
                  msg: "SUCCESS",
                  launch_url: `https://${GAME_DOMAIN}/${codegame}/index.html?operator_token=Zm9saWFiZXQ=&btt=1&t=${getnewuser[0].token}&or=${GAME_DOMAIN}&api=${GAME_DOMAIN}`,
            ...
            res.send({
               status: 1,
               msg: "SUCCESS",
               launch_url: `https://${GAME_DOMAIN}/${codegame}/index.html?operator_token=Zm9saWFiZXQ=&btt=1&t=${user[0].token}&or=${GAME_DOMAIN}&api=${GAME_DOMAIN}`,
